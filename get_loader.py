...
class Vocabulary:
    def __init__(self, freq_threshold):
        # Index to String vocab
        self.itos = {0: "<PAD>", 1: "<START>", 2: "<END>", 3: "<UNK>"}
        # String to Index vocab
...
class VizWizDatabase(Dataset):
    def __init__(self, root_dir, captions_file, transform=None, freq_threshold=5):
        self.root_dir = root_dir
        self.df = self.merge_captions_with_images(captions_file)
    ...
    @staticmethod
    def merge_captions_with_images(captions_file):
...
def get_loader(
    ...
    dataset = VizWizDatabase(root_folder, annotation_file, transform=transform)
